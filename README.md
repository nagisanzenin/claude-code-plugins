...
|--------|---------|-----------------|
| **production-grade** | 5.5.2 | Polymath co-pilot, PM, Architect, Backend, Frontend, QA, Security, Code Review, DevOps, SRE, Data Scientist, Technical Writer, Skill Maker, Orchestrator |
